...
class AccountUser extends Model {
    ...
    {
        return $this->hasOne('App\Models\NotificationPreferences')->withDefault([
            'assignment_reminder_frequency' => 'weekly',
            'transfer_warning_modal_dismissed' => false,
            'defense_reminder_frequency' => 'never', // this property is deprecated, the reminder as been removed
        ]);
    }
