...
class UserDetailsResourceTest extends TestCase
{
    public function testUserDetailsResourceV1Types()
    {
        ...
        $testUser->refresh();
        $testResource = new UserDetailsResourceV1($testUser);
        ...
        $this->assertTrue($testResource['current_account_user'] instanceof AccountUserDetailsResourceV1);
