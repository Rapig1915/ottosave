...
class IncomeAccountOverviewResourceTest extends TestCase
{
    public function testIncomeAccountOverviewResourceV1Types()
    {
        ...
        $testResource = new IncomeAccountOverviewResourceV1($testBankAccount);
