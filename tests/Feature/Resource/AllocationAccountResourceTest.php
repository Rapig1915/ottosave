...
class AllocationAccountResourceTest extends TestCase
{
    public function testAllocationAccountResourceV1Types()
    {
        ...
        $testAllocationOut = Allocation::factory()->create([
            'transferred_from_id' => $testBankAccount->id,
            'transferred' => true
        ]);
        ...
        $testResource = new AllocationAccountResourceV1($testBankAccount);
        ...
        $this->assertTrue($testResource['uncleared_allocations_out'][0] instanceof AllocationResourceV1);
